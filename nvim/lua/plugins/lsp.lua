	...
	-- lsp servers
	{
		...
		opts = {
			...
			servers = {
				eslint = {
					...
					root_dir = function(fname)
						...
						local workspace_root =
							util.root_pattern("turbo.json", "pnpm-workspace.yaml", "yarn.workspaces")(fname)
				...
				tsserver = {
					root_dir = function(fname)
						-- The root must be the directory containing tsconfig.json and tsconfig.base.json
						local root = require("lspconfig.util").root_pattern(
							"tsconfig.json",
							"tsconfig.base.json",
							"package.json",
							".git" -- keep .git as a fallback
						)(fname)
